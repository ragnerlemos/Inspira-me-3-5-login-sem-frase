...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background/60 p-4 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 backdrop-blur-sm",
  {
    variants: {
      side: {
...
interface SheetContentProps
  ...
  onOverlayClick?: (e: React.MouseEvent<HTMLDivElement> | React.TouchEvent<HTMLDivElement>) => void;
}
...
>(({ side = "right", className, children, onOverlayClick, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay onClick={onOverlayClick} onTouchEnd={onOverlayClick} />
